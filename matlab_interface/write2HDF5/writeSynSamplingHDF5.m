...
if n_match == 0
    ...
    hdf5write(FID,['/config/syns/syn',num2str(n_match),'/SAMP002/sample_ind'], sample_ind);
    hdf5write(FID,['/config/syns/syn',num2str(n_match),'/SAMP002/time_index'], time_index);
end
