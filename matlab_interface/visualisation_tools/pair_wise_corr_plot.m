function [ah_bi, ah_uni ] = pair_wise_corr_plot(X, VarName, varargin)
% This function visualizes pair-correlations among multiple variables using
% 3D histogram and also plots univariate histograms. All of the axes limits
% and color scales are synchronized across the subplots.
%
% [ah_bi, ah_uni ] = pair_wise_corr_plot(X, VarName, varargin)
% 
% Input arguments:
