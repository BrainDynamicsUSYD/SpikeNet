...
public:
	...
	void init(int synapses_type, int pop_ind_post, int N_pre, double K_ext, int Num_ext, vector<double> &rate_ext_t); // initialise chemical synapses for simulating external Poissonian neuron population
...
protected:
	...
	int 
		Num_ext; // number of external pre-synaptic neurons (chemical synapses)
	vector<double> 
