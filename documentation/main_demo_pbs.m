function main_toturial()
% Important! Must use coherent units: msec+mV+nF+miuS+nA
...
% For toturial purpose, the values used as following are the still the
% default ones.
% If default values are to be used, there is no need to define them.
