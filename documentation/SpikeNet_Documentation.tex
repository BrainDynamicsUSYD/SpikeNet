...
\begin{itemize}
\item To get the most recent version of SpikeNet: \mylstinline{git pull origin master; make; make clean;}
...
\begin{itemize}
\item Make sure you have doxygen and graphviz installed.
\item Go to the SpikeNet directory.
\item Generate the documents: \mylstinline{doxygen}
\item Edit the following variables in the bash script accordingly: 
\end{itemize}
