function RasterGC_ELIF( Result_cell, save_figure )
...
%     Num_pop = 1;
    ...
    for seg = 1:seg_num
        ...
        if save_figure == 1
            ...
            % if you need save it as tiff or pdf uncomment the next line
            print(h_raster, '-dtiff', strcat( R.stamp, '_raster_',sprintf('%02g', seg)));
            % saveas(h_raster, strcat( R.stamp, '_raster_',sprintf('%02g', seg)), 'fig');
            % delete(h_raster);
            close gcf; clear gcf;
            fprintf('done.\n');
        else
