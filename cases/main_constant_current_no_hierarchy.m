function main_constant_current_no_hierarchy(varargin)
% Do it!!!
% Find it!!!
% Hunt it down!!!
...
for lesion_rest = 0.5:0.05:1.0
    for I_ext_strength = 1.5*ones(1,10)
        ...
        for i_pre = 1:2
            for j_post = 1:2
                ...
                if i_pre == 1 && j_post == 1
                    ...
                    % Do lesion here
                    P(CL>=2) = unique(P(CL==2))*lesion_rest; % third-highest level connection
        ...
        writeExplVar(FID, 'discard_transient', discard_transient, ...
            ...
            'lesion_rest',lesion_rest,'lesion_1',lesion_1);
