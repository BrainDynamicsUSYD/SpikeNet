function main_example_noisy(varargin)
% Do it!!!
% Find it!!!
% Hunt it down!!!
...
for rate_ext = 4.4*ones(1,50) %l
    ...
    writeExplVar(FID, 'discard_transient', discard_transient, ...
        ...
        'EE_factor', EE_factor, ...
        'II_factor', II_factor, ...
        'rate_ext', rate_ext,  'Num_ext',  Num_ext, ...
