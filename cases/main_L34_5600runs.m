function main_L34_5600runs(varargin)
...
for lesion_left_3 = 0.1:0.1:1.4 %1.1:0.1:1.4 % range [0-1]
    
    for lesion_left_4 = 0.1:0.1:1.0
                        ...
                        for Mnum = 8 %!!!
                            ...
                            for rate_ext = 4.4*ones(1,40) %linspace(4.0,4.0,45) %4.0:0.025:4.5 %4.1:0.025:4.5; % Hz
                                    ...
                                    for j_post = 1:2
                                        if hierarchy_model ~= 0
                                            if i_pre == 1 && j_post == 1
                                                ...
                                                % Do lesion here
                                                P(CL==4) = P(CL==4)*lesion_left_4; % highest level connection
                                                P(CL==3) = P(CL==3)*lesion_left_3;  %*lesion_left;  % second-highest level connection
                                ...
                                writeExplVar(FID, 'discard_transient', discard_transient, ...
                                    ...
                                    'EE_factor', EE_factor, ...
                                    'II_factor', II_factor,...
                                    'lesion_left_4',lesion_left_4,...
                                    'lesion_left_3',lesion_left_3);
