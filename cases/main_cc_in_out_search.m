                        ...
                        for II_factor = [ 0.6 0.8]
                            for EI_factor = [ 1.0 ]
                                for degree_CV = [0.5 ] % 0.5?
                                    for  P0_init = [ 0.1 ]
                                        for I_ext_strength_E = [ 0.05:0.05:0.2 ]% 0.9*ones(1,10)]
                                            for I_ext_strength_I = [0.1]% 0.9*ones(1,10)]
                                                for  tau_c = [10 15]
                                                    loop_num = loop_num + 1;
                                                    ...
                                                    K_mu_log = K_mat(1,1);
                                                    K_sigma_log = EE_CV*K_mu_log;
                                                    [I_e, J_e, K_ee, N_e, iter_hist] = spatial_embed_in_out_network(...
                                                        hw, P0_init, degree_CV, tau_c, in_out_corrcoef, ...
                                                        K_mu_log, K_sigma_log, cn_scale_wire, cn_scale_weight);
                                                    
                                                    
                                                    [ EPSP ] = g_2_EPSP( K_ee );
                                                    [EPSP_Y, EPSP_X] = hist(EPSP, 50);
                                                    clear EPSP;
