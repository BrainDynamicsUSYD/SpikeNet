function main_cc_lesion_all_visiting(varargin)
% will the entire stochastic approach towards connectivity be problematic??
        ...
        for syn_i = 1:8
            ...
            for I_ext_strength = 1.5
                ...
                for s = 1:length(syn_cell)
                    ...
                    % do lesion here
                    if syn_cell{s}.pop_pre == 1 &&  syn_cell{s}.pop_post == 1
                        % reproduce Msize, P and CL for
                        % example_constant_current
                        P0 = 0.2;
                        ...
                        %
                        syn_cell{s} = do_lesion_adhoc(syn_cell{s}, Msize, P, CL, lesion_level, lesion_ratio);
                    end
                ...
                writeExplVar(FID, 'discard_transient', discard_transient, ...
                    ...
                    'syn_i', syn_i, 'lesion_level',lesion_level, 'lesion_ratio', lesion_ratio);
