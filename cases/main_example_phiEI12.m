function main_example_phiEI12(varargin)
    ...
    for lesion_2 = 1    %+(-0.05:0.05:0.05)
        for lesion_3 = 1    %+(-0.05:0.05:0.05)
            for lesion_4 = 0.5  %+(-0.05:0.05:0.05)
                ...
                for rate_ext = 4.4*ones(1,50) %4.4*ones(1,1) %linspace(4.0,4.0,45) %4.0:0.025:4.5 %4.1:0.025:4.5; % Hz
